...
@Slf4j
public class WebClientService1 {
    ...
    public Seats getSeats(Rates1 rates, Time time, UpDown upDown) {
    ...
    public Seats getSeatsByGetOff(Rates1 rates, Time time, UpDown upDown) {
        List<Seat> seats = new ArrayList<>();
